...
public class JLibrosa {
	 ...
	 */
	public float[][] loadAndReadAcrossChannelsWithOffset(String path, int sr, int readDurationInSec, int offsetDuration, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {
		float[][] magValues = readMagnitudeValuesFromFile(path, sr, readDurationInSec, offsetDuration, context, raw);
		return magValues;
	}
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	public float[][] loadAndReadAcrossChannels(String path, int sr, int readDurationInSec, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {
		float[][] magValues = loadAndReadAcrossChannelsWithOffset(path, sr, readDurationInSec, 0, context, raw);
		return magValues;
	}
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	private float[][] readMagnitudeValuesFromFile(String path, int sampleRate, int readDurationInSeconds, int offsetDuration, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {

		File sourceFile = new File(path);
		WavFile wavFile = null;

		wavFile = WavFile.openWavFile(sourceFile, context, raw);
		...
		wavFile.readFrames(buffer, mNumFrames, frameOffset);
	...
	private float[][] readMagnitudeValuesFromFile(File file, int sampleRate, int readDurationInSeconds, int offsetDuration)
			throws IOException, WavFileException, FileFormatNotSupportedException {

		WavFile wavFile = null;

		wavFile = WavFile.openWavFile(file, null, -1);
		int mNumFrames = (int) (wavFile.getNumFrames());
		int mSampleRate = (int) wavFile.getSampleRate();
		int mChannels = wavFile.getNumChannels();
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	public float[] loadAndReadWithOffset(String path, int sampleRate, int readDurationInSeconds, int offsetDuration, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {
		float[][] magValueArray = readMagnitudeValuesFromFile(path, sampleRate, readDurationInSeconds, offsetDuration, context, raw);
	...
	public float[] loadAndReadWithOffset(File path, int sampleRate, int readDurationInSeconds, int offsetDuration)
			throws IOException, WavFileException, FileFormatNotSupportedException {
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	public float[] loadAndRead(String path, int sampleRate, int readDurationInSeconds, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {

		float[] meanBuffer = loadAndReadWithOffset(path, sampleRate, readDurationInSeconds, 0, context, raw);
		return meanBuffer;
	}

	public float[] loadAndRead(File file, int sampleRate, int readDurationInSeconds)
			throws IOException, WavFileException, FileFormatNotSupportedException {

		float[] meanBuffer = loadAndReadWithOffset(file, sampleRate, readDurationInSeconds, 0);
		return meanBuffer;
	}
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	public float[][] loadAndReadStereoWithOffset(String path, int sampleRate, int readDurationInSeconds, int offsetDuration, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	public float[][] loadAndReadStereo(String path, int sampleRate, int readDurationInSeconds, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {

		float[][] stereoAudioArray = loadAndReadStereoWithOffset(path, sampleRate, readDurationInSeconds, 0, context, raw);
		return stereoAudioArray;
	}
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	public ArrayList<Float> loadAndReadAsListWithOffset(String path, int sampleRate, int readDurationInSeconds, int offsetDuration, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {
		...
		for (int q = 0; q < mNumFrames; q++) {
			...
			meanBufferList.add((float) (frameVal / mChannels));
		}
	 ...
	 * @throws FileFormatNotSupportedException
	 */
	public ArrayList<Float> loadAndReadAsList(String path, int sampleRate, int readDurationInSeconds, Context context, int raw)
			throws IOException, WavFileException, FileFormatNotSupportedException {

		ArrayList<Float> meanBufferList = loadAndReadAsListWithOffset(path, sampleRate, readDurationInSeconds, 0, context, raw);
		return meanBufferList;
	}
}